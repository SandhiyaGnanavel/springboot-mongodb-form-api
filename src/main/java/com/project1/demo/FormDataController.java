...
public class FormDataController {
    ...
    @DeleteMapping("/{id}")
     public ResponseEntity<String> deletFormData(@PathVariable String id){
       form.deleteById(id);
       return ResponseEntity.ok("Form deleted successfully + id");
     }
...
// }
    @DeleteMapping
    public ResponseEntity<String> deletFormAllData(){
        form.deleteAll();
